          ...
          <div className="p-4 space-y-2">
            ...
            <div className="mb-6">
              <button
                ...
                className="flex items-center justify-between w-full px-3 py-2 text-sm font-semibold text-gray-500 uppercase tracking-wide hover:text-gray-700"
              >
                <span>Dashboard</span>
                <svg
                  className={`w-4 h-4 transition-transform duration-200 ${showDashboard ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
