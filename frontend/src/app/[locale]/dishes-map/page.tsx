          ...
          >
            <g id="features">
              ...
              <path 
                ...
                id="OMMU" 
                name="Musandam" 
                fill={hoveredGovernorate === 'musandam' ? '#059669' : '#14B8A6'}
                stroke="#0F766E" 
                strokeWidth="2" 
              ...
              <path 
                ...
                fill={hoveredGovernorate === 'al-batinah-north' ? '#1D4ED8' : '#3B82F6'}
                stroke="#1E40AF" 
                strokeWidth="2" 
                className="cursor-pointer transition-all duration-300"
              ...
              <path 
                ...
                id="OMBU" 
                name="Al Buraimi" 
                fill={hoveredGovernorate === 'al-buraimi' ? '#4F46E5' : '#6366F1'}
                stroke="#4338CA" 
                strokeWidth="2" 
                className="cursor-pointer transition-all duration-300"
              ...
              <path 
                ...
                id="OMZA" 
                name="Ad Dhahirah" 
                fill={hoveredGovernorate === 'ad-dhahirah' ? '#77B900' : '#84CC16'}
                stroke="#65A30D" 
                strokeWidth="2" 
                className="cursor-pointer transition-all duration-300"
              ...
              <path 
                ...
                id="OMZU" 
                name="Dhofar" 
                fill={hoveredGovernorate === 'dhofar' ? '#DC2626' : '#EF4444'}
                stroke="#DC2626" 
                strokeWidth="2" 
                className="cursor-pointer transition-all duration-300"
              ...
              <path 
                ...
                id="OMWU" 
                name="Al Wusta" 
                fill={hoveredGovernorate === 'al-wusta' ? '#EC4899' : '#F472B6'}
                stroke="#EC4899" 
                strokeWidth="2" 
                className="cursor-pointer transition-all duration-300"
              ...
              <path 
                ...
                fill={hoveredGovernorate === 'ash-sharqiyah-south' ? '#0891B2' : '#06B6D4'}
                stroke="#0891B2" 
                strokeWidth="2" 
                className="cursor-pointer transition-all duration-300"
              ...
              <path 
                ...
                fill={hoveredGovernorate === 'ash-sharqiyah-north' ? '#EA580C' : '#F97316'}
                stroke="#EA580C" 
                strokeWidth="2" 
                className="cursor-pointer transition-all duration-300"
              ...
              <path 
                ...
                id="OMMA" 
                name="Muscat" 
                fill={hoveredGovernorate === 'muscat' ? '#D97706' : '#F59E0B'}
                stroke="#D97706" 
                strokeWidth="2" 
                className="cursor-pointer transition-all duration-300"
              ...
              <path 
                ...
                fill={hoveredGovernorate === 'al-batinah-south' ? '#7C3AED' : '#8B5CF6'}
                stroke="#7C3AED" 
                strokeWidth="2" 
                className="cursor-pointer transition-all duration-300"
              ...
              <path 
                ...
                id="OMDA" 
                name="Ad Dakhiliyah" 
                fill={hoveredGovernorate === 'ad-dakhiliyah' ? '#047857' : '#10B981'}
                stroke="#047857" 
                strokeWidth="2" 
                className="cursor-pointer transition-all duration-300"
