// services/place_service.go - Updated for new model structure
package services
...
func CreatePlaceContentSection(placeID uuid.UUID, req dto.CreateContentSectionRequest, userID uuid.UUID) (*dto.ContentSectionResponse, error) {
	// Verify place exists and user has permission
	var place domain.Place
	...
	if place.CreatedBy != userID {
		return nil, errors.New("unauthorized to add content to this place")
	}
...
func UpdatePlaceContentSection(id uuid.UUID, req dto.UpdateContentSectionRequest, userID uuid.UUID) (*dto.ContentSectionResponse, error) {
	...
	if section.Place.CreatedBy != userID {
		return nil, errors.New("unauthorized to update this content section")
	}
...
func DeletePlaceContentSection(id uuid.UUID, userID uuid.UUID) error {
	...
	if section.Place.CreatedBy != userID {
		return errors.New("unauthorized to delete this content section")
	}
